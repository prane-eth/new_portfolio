...
import { githubUrl, web3_repo } from './constants';
	...
	const projects = [
		{
			...
			github: `${githubUrl}/${web3_repo}/tree/main/invoice_app-client`,
		...
		},
		{
			...
			techStack: ["React", "Solidity", "Ethereum (web3)"],
			github: `${githubUrl}/${web3_repo}/tree/main/todo-client`,
		...
		},
		{
			...
			github: `${githubUrl}/Graveyard_tracker`,
		...
		},
		{
			...
			github: `${githubUrl}/Crypto_price_alerts`,
			website: "",
			important: false
		},
		{
			...
			github: `${githubUrl}/COVI-neeD_helper`,
			website: "",
			important: false
		},
		{
		...
		},
		{
			...
			github: `${githubUrl}/online_voting_system_flask`,
			website: "",
			important: false
		},
		{
			...
			github: `${githubUrl}/RPi_accident_alert_system`,
			website: "",
			important: false
		},
	]
	...
	return (
		<div id="Projects">
			...
			<div className="project-card">
				<h2>More projects</h2>
				<div className="project-links">
					<FaGithub href={`${githubUrl}?tab=repositories`} target="_blank" rel="noreferrer" />
				</div>
			</div>
		</div>
	);
